...
public class BlogPostDAO {
    ...
    public String addPost(String title, String body, List tags, String username) {
        ...
        post.append("permalink", permalink)
                ...
                .append("comments", new ArrayList(0));
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        ArrayList comments = document.get("comments", ArrayList.class);
        comments.add(comment);

        postsCollection.updateOne(eq("_id", document.getObjectId("_id")),
                new Document("$set", new Document("comments", comments)),
                new UpdateOptions().upsert(true));

//        postsCollection.findOneAndReplace(eq("_id", document.getObjectId("_id")), document);
    }
}
